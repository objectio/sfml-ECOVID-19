...
int main() {
	...
	Texture garbageTex3;
	garbageTex3.loadFromFile("images/straw_garbage.png");
	Sprite strawGarbage;
	strawGarbage.setTexture(garbageTex3);

	Texture garbageTex4;
	garbageTex4.loadFromFile("images/chicken_garbage.png");
	Sprite chickenGarbage;
	chickenGarbage.setTexture(garbageTex4);

	Texture garbageTex5;
	garbageTex5.loadFromFile("images/pizza_garbage.png");
	Sprite pizzaGarbage;
	pizzaGarbage.setTexture(garbageTex5);

	Texture garbageTex6;
	garbageTex6.loadFromFile("images/postbox_garbage.png");
	Sprite boxGarbage;
	boxGarbage.setTexture(garbageTex6);

	Sprite garbages[6];
	garbages[0] = cakeGarbage;
	garbages[1] = coffeeGarbage;
	garbages[2] = strawGarbage;
	garbages[3] = chickenGarbage;
	garbages[4] = pizzaGarbage;
	garbages[5] = boxGarbage;
	Position GarbagePosition;
	GarbagePosition.x = WIDTH - 20;
	GarbagePosition.y = HEIGHT - 20;
